#' Convert a Standard Score to All Possible Standard Score Types with Confidence Intervals
#'
...
#' @export
#' @examples
#' convert_all_with_ci(65, from = "t_score")
#' convert_all_with_ci(120, from = "iq", rel = 0.9, ci = 90)
#' convert_all_with_ci(75, from = "custom", m = 80, sd = 5)
convert_all_with_ci <- function(score, from, m = NULL, sd = NULL, rel = 0.85, rtm = TRUE, ci = 95) {
