...
The data in the `data/` directory of this repository is provided under the following terms:

1. **Use within this project only**: You may use this data solely as part of the **PsychometricCurse** project.
2. **No redistribution**: You may not redistribute, republish, or use this data in other projects without explicit written permission from the data contributors.
...
7. **Limited Liability and Warranty**: The data is provided "as is", without warranty of any kind, express or implied. The authors and contributors shall not be held liable for any errors, omissions, or inaccuracies in the data, nor for any interpretations, analyses, or applications derived from the data. In no event shall the authors or contributors be liable for any claim, damages, or other liability arising from, out of, or in connection with the data or its use.
