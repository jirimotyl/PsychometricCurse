...
The name is also a play on words: "curse" is similar to "course," as this package allows you to easily apply Reliable Change Index (RCI) and other concepts to evaluate change in scores over time.
...
### Code
The code in this repository is licensed under the **GNU GPL 3.0**. See [LICENSE](LICENSE) for details.
...
- The data is provided **"as is"**, without warranty of any kind. The authors and contributors are not liable for any errors, omissions, or inaccuracies in the data, nor for any interpretations or applications derived from it.
